...
export default function ProductPage(props) {
  return (
    <section className='wrapper-item'>
        <ProductMain image = {props.image} description = {props.description} name = {props.name} rating = {props.rating} proteins = {props.proteins} fats = {props.fats} carbohydrates = {props.carbohydrates} calories = {props.calories} cost = {props.cost} view = {props.view} buy = {props.buy} Kg = {props.Kg}/>
